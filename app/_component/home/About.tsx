...
const About = () => {
  return (
    <div className="flex min-h-120 flex-col items-start gap-4">
      <h3 className="text-head text-4xl font-semibold">About</h3>
      <div className="flex w-full flex-col-reverse gap-6 md:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-6">
          ...
          <Button variant={"primary"} className="mr-auto px-5 font-medium">
      ...
      <div className="flex flex-col justify-center gap-4">
        <Link
          ...
          className="text-accent flex items-center gap-2 text-base font-semibold"
        >
